...
<?php if (empty($this->oPosts)): ?>
    <p class="bold">Aún no hay publicaciones.</p>
    <p><button type="button" onclick="window.location='<?=ROOT_URL?>?p=blog&amp;a=add'" class="bold">¡Agrega tu primer Post!</button></p>
<?php else: ?>
    ...
    <?php foreach ($this->oPosts as $oPost): ?>
        ...
        <p><a href="<?=ROOT_URL?>?p=blog&amp;a=post&amp;id=<?=$oPost->id?>">¿Quieres ver más?</a></p>
        <p class="left small italic">Creado el <?=$oPost->createdDate?></p>
